...
class ventanaClient:
	...
	def __init__(self):
		...
		self.instructionMessage.set("Ingrese la clave del servidor para iniciar la conexion")
		...
		self.entry_player1Name.insert(ANCHOR,"")
	...
	def ok(self):
		...
		if self.player1Name != "" :
			...
			if self.player1Name == "":
				self.entry_player1Name.insert(ANCHOR,"0")
	def no(self):
		self.player1Name = "0"
		self.frame.destroy()
